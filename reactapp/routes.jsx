...
export const RESET_PASSWORD_TEXT = "Enter password reset code";
export const RESEND_ACTIVATION_LINK = "/resend-activation-code";
export const RESEND_ACTIVATION_TEXT = "Re-send activation code";
